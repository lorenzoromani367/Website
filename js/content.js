...
const PROJECTS = [
  {
    ...
    images: [
      ...
      },
      {
        ...
        mobile: { width: "320px", height: "258px" },
      },
      { caption: "church", src: "images/lines/lines-5.jpg", width: "440px", height: "622px", mobile: { width: "280px", height: "396px" } },
      { caption: "olympus", src: "images/lines/lines-6.jpg", width: "520px", height: "599px", captionOffset: { x: 100, y: 360 }, mobile: { width: "320px", height: "369px" } },
      { caption: "construction", src: "images/lines/lines-7.jpg", width: "520px", height: "590px", mobile: { width: "300px", height: "340px" } },
      { caption: "unfinished", src: "images/lines/lines-8.jpg", mobile: { width: "300px", height: "350px" } },
      { caption: "mountain pasture", src: "images/lines/lines-9.jpg", width: "480px", height: "568px", mobile: { width: "300px", height: "355px" } },
      { caption: "home", src: "images/lines/lines-10.jpg", width: "420px", height: "663px", offset: { x: 120, y: 300 }, captionOffset: { x: -120, y: 400 }, mobile: { width: "260px", height: "411px" } },
      { caption: "field", src: "images/lines/lines-11.jpg", width: "460px", height: "575px", captionOffset: { x: 100, y: 360 }, mobile: { width: "300px", height: "375px" } },
      {
        caption: "ignored column",
        src: "images/lines/lines-12.jpg",
        mobile: { width: "320px", height: "363px" },
      },
      { caption: "emst", src: "images/lines/lines-13.jpg", width: "480px", height: "640px", mobile: { width: "280px", height: "373px" } },
    ],
  },
  {
    slug: "stills",
